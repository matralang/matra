...
export type StartRuleNames = "Matra";
export interface ParseOptions<T extends StartRuleNames = "Matra"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Matra">>(
  input: string,
  options?: Options,
): any;
